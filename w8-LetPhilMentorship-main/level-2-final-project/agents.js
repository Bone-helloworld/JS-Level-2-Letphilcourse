...
//       <span style="float:right; background:rgba(255,255,255,0.1); padding:4px 12px; border-radius:9999px; font-size:0.8rem;">${agent.risk} Risk</span>
//       <h3 style="margin:1rem 0 0.5rem; font-size:1.45rem;">${agent.name}</h3>
//     </div>
//     <div class="chart-container" style="height:190px; background:#0a0f1c; padding:1rem; display:flex; align-items:center; justify-content:center;">
//       <svg width="100%" height="100%" viewBox="0 0 320 160" fill="none">
//         <path d="M20 130 Q80 110 120 125 Q170 80 220 65 Q270 40 300 25" stroke="${agent.color}" stroke-width="5" stroke-linecap="round"/>
//         <circle cx="80" cy="110" r="6" fill="${agent.color}"/>
//         <circle cx="170" cy="80" r="6" fill="${agent.color}"/>
//         <circle cx="270" cy="40" r="6" fill="${agent.color}"/>
//       </svg>
//     </div>
...
//         <div style="font-size:1.45rem; font-weight:700; color:#10b981;">+${agent.roi}%</div>
//       </div>
//       <button onclick="toggleFollow(this, ${agent.id})" class="follow-btn" style="background:#10b981; color:#000; border:none; padding:10px 22px; border-radius:9999px; font-weight:700; cursor:pointer;">Follow</button>
//     </div>
//   `;
//   return card;
// }
