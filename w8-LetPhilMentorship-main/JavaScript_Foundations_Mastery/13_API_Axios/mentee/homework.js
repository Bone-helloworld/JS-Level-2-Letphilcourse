...
searchCountryBtn.addEventListener("click", async () => {
    ...
    try {
        ...
        // const capital = countryData.capital ? countryData.capital[0] : "Non exist";
        // const region = countryData.region;
        // const population = countryData.population;
        countryNameDisplay.textContent = countryData.name.common;
        countryPopulationDisplay.textContent = countryData.population.toLocaleString();
        countryCapitalDisplay.textContent = countryData.capital ? countryData.capital[0] : "Non exist";
        countryRegionDisplay.textContent = countryData.region;
