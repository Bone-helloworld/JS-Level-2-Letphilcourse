...
colorInput.addEventListener("input", () => {
  ...
  colorValueText.textContent = inputFavColor === "" ? "none yet" : inputFavColor;
})
...
moodSelect.addEventListener("change", () => {
  const moodSelectInput = moodSelect.value;
  profileMoodDisplay.textContent = `Current mood: ${moodSelectInput} ` 
})
