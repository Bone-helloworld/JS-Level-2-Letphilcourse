...
const changeTitle = document.getElementById("changeTitleBtn");
const toggleHighlight = document.getElementById("toggleHighlightBtn");
const counterSpan = document.getElementById("counterValue");
const incrementBtnChange = document.getElementById("incrementBtn");
const textInput = document.getElementById("previewInput");
...
changeTitle.addEventListener("click", () => {
    title.textContent = "Wave 7 - Events in Action"
    description.textContent = "The title was changed by clicking the button"
})
// ==============================================
...
toggleHighlight.addEventListener("click", () => {
    mainCard.classList.toggle("event-card-highlight")
})
// ==============================================
...
incrementBtnChange.addEventListener("click", () => {
    counter++;
...
textInput.addEventListener("input", () => {
    ...
    previewSpan.textContent = currentValue === "" ? "Nothing typed yet." : currentValue;
})